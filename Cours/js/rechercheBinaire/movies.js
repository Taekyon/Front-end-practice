...
/* TODO:
 - faire en sorte que l'ordre des clés (title, year, ...) ne soit pas trier par ordre alphabétique.
 ~ enlever l'article devant le titre.
 - rajouter la création de div dans une fonction */

// sort alphabetically
let moviesSorted = movies.sort((a, b) => {
  if (a.title.toLowerCase() > b.title.toLowerCase()) return 1;
  if (a.title.toLowerCase() < b.title.toLowerCase()) return -1;
  return 0; // titleA must be equal to titleB
});

// function to export
// export { aToZ(a, b) };
// export default { moviesRenamed }

// div in HTML
let createDiv = document.createElement("div");
document.body.appendChild(createDiv);

// Map to rename (OPTIONAL)
let moviesRenamed = moviesSorted.map((val) => {
  return val.title;
});
console.log(moviesRenamed[23], moviesRenamed[156], moviesRenamed[201]);

// correct spacing : moviesRenamed.join(', ');
createDiv.innerHTML = moviesRenamed[2];